...
<kbd>
<img src=/lab-01/images/composer_1.png />
</kbd>
...
* Open the file from the downloaded code repository at `customer_churn/00-scripts/variables.json` and edit the variables as per your environment
...
<kbd>
<img src=/lab-01/images/composer_4.png />
</kbd>
...
* Click on **Choose File** and select the file from the downloaded code repository at `customer_churn/00-scripts/variables.json`
