...
churn_dataset_df = spark.read.options(inferSchema = True, header= True).csv('gs://'+bucket_name+'/customer_churn/01-datasets/customer_churn_train_data.csv')
...
bucket = bucket_name+"/customer_churn"
